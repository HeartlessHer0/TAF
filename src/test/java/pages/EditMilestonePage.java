...
public class EditMilestonePage extends BasePage {
    ...
    private By deleteButtonLocator = By.linkText("Delete this milestone");
    ...
    public WebElement getDescriptionDisplay(){return  waitsService.waitForClickableElement(descriptionDisplayLocator);}
    ...
    public WebElement getConfirmDeleteCheckbox(){return waitsService.waitForVisibilityLocatedBy(confirmDeleteCheckboxLocator);}
    public WebElement getConfirmDeleteButton(){return waitsService.waitForClickableElement(confirmDeleteButtonLocator);}
}
